...
def plot_align(number_of_cell,ref_frame, frame_to_align, k_sampling_points):
    ...
    border_ref= project_on_kendall_space(border_ref)
    ...
    border_align = align(border_cell, border_ref, rescale=True, rotation=False, reparameterization=True, k_sampling_points=k_sampling_points)
    ...
    fig.add_subplot(133)
    border_align = project_on_kendall_space(border_align)
